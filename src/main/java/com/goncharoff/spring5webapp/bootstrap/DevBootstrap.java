package com.goncharoff.spring5webapp.bootstrap;
...
import com.goncharoff.spring5webapp.repositories.BookRepository;
import com.goncharoff.spring5webapp.repositories.PublisherRepository;
...
public class DevBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private void initData() {
        ...
        Publisher publisher = new Publisher("Puckt", "India");
        ...
        Publisher publisher1 = new Publisher("SOme", "Japan");
